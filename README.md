# UNVEIL | Concept store
Este es un proyecto de ecommerce básico que se utiliza para el curso de React. La aplicación permite ver una lista de zapatillas y realizar compras en línea. 
